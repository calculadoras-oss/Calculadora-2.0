...
const CM_ARTIGOS = [
  ...
  { file: 'artigo-ipca-m2-inflacao-real.html', icon: '💵', name: 'IPCA, BCB ou M2: Qual é a Inflação Real?', desc: 'Por que o M2 cresce muito mais rápido que o IPCA — e o que isso significa pro seu bolso.' },
